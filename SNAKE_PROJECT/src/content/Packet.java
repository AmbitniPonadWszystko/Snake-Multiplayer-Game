...
public class Packet {
    ...
    public static class PacketColorAccepted {
    }
    public static class PacketColorRefused {
    }
    ...
    public static class PacketAskForColor {
        String colorName;
    }  
    public static class PacketAskForColors {
    }

    public static class PacketSendColor {

        String color;
    }
    public static class PacketPlayersColors {
